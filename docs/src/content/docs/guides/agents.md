...
- [`review_agents`](/no-mistakes/reference/global-config/#review_agents) - independent reviewer and fixer harness plus model/effort profiles for the review loop; other pipeline steps keep the normal agent selection.
